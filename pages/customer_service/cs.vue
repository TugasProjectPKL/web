        ...
        <div class="row justify-content-between">
          <div class="col-lg-5">
            <div class="intro-excerpt">
              <div class="text-end"> <!-- Mengatur ke pojok kanan atas -->
        <nuxt-link to="/" class="btn btn-white mb-1"> <!-- Tautan kembali ke halaman utama -->
          <i class="fa fa-home"></i> <!-- Ikon home -->
        </nuxt-link>
      </div>
              ...
              <div class="form-group row">
                <div class="col-md-12">
                  <label for="c_address" class="text-black"
                    >Nomor Invoice <span class="text-danger">*</span></label
                  >
                  <input
                    type="text"
                    class="form-control"
          ...
          <div class="col-lg-4">
            <div class="mb-4 footer-logo-wrap">
              <a href="#" class="footer-logo"
                >Starindo Multi Industri<span>.</span></a
              >
            </div>
            <p class="mb-4">
          ...
          <div class="row pt-4">
            <div class="col-lg-6">
              <p class="mb-2 text-center text-lg-start">
                Copyright &copy; date here All Rights Reserved. &mdash; Designed
                with love by <a href="https://untree.co">Untree.co</a> Distributed
                By <a hreff="https://themewagon.com">ThemeWagon</a>
