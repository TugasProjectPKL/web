  ...
  <div class="product-section">
    <div class="container">
      <div class="row">
        ...
        <!-- Start Column 1 -->
        <div v-for="(item,index) in products" class="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
          <a class="product-item" href="cart.html">
            ...
            <strong class="product-price">Rp. {{ item.product_price }}</strong>

            <span class="icon-cross">
              <img src="@/assets/images/cross.svg" class="img-fluid" alt="image" />
            </span>
          </a>
        </div>
