...
<div class="container">
  <div class="row">
    ...
    <!-- Start Column 4 -->
    <div v-for="item in products" class="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
      <a class="product-item" href="cart.html">
        <img :src="item.product_image ?? ''" class="img-fluid product-thumbnail" alt="tes">
        <h3 class="product-title">{{item.product_name}}</h3>
        <strong class="product-price">Rp {{item.product_price}}/Dus</strong>

        <span class="icon-cross">
          <img src="@/assets/images/cross.svg" class="img-fluid" alt="tes">
        </span>
      </a>
    </div>
    <!-- End Column 4 -->
